                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img width="300" src="images/icon/logo.png" alt="">
                            </a>
                        </div>
                        ...
                        <?php 
                            ...
                            $query = mysqli_query($conexao,"SELECT Usuario_Email,Usuario_Senha,Usuario_Codigo FROM usuario WHERE Usuario_Email = '$email_form'");
                            ...
                            while($busca=mysqli_fetch_array($query)) {
                                ...
                                if($busca["Usuario_Email"]==$email_form and $busca["Usuario_Senha"]==$senha_form) {
                                    session_start();
									$_SESSION['sessao'] = "159326874";

						 ...
						 <div class="col-lg-6">
							<div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="servicospost/addservico.php" method="POST" class="">
                                            <div class="form-group">
                                                <label for="nf-email" class="form-control-label">Nome do Serviço</label>
                                                <input type="text"   name="nomeserv" placeholder="Nome..." class="form-control">                                                
                                            </div>
                                            <div class="form-group">
                                                <label for="nf-email" class="form-control-label">Tempo de duração (em minutos) </label>
                                                <input type="text"  name="temposerv" placeholder="Tempo..." class="form-control">                                                
                                            </div>
											<div class="form-group">
                                                <label for="nf-email" class="form-control-label">Preço do Serviço </label>
                                                <input type="text"  name="precoserv" placeholder="Preço..." class="form-control">                                                
                                            </div>

                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="videopost/addvideo.php" method="POST" enctype="multipart/form-data" class="form-horizontal">								
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="link" rows="9" class="form-control">...</textarea>	
													<small class="form-text text-muted"> Máx: 500 caracteres </small>													
                                                </div>
                                            </div>
							...
							<div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
										...
										<img src="images/passo1.png"><br>
										2. Clique em incorporar
										<img src="images/passo2.png"><br>
										3. Copie todo o código da caixa (iframe... )

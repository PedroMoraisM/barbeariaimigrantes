                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="produtopost/addprod.php" method="POST" enctype="multipart/form-data" class="form-horizontal">								
									...
									<div class="card-body card-block">                                                                   
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
													...
													<small class="form-text text-muted">O tamanho será ajustado para 300x300.</small>
                                                </div>
											</div>                               

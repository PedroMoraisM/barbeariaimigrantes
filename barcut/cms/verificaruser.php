                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="verificaruser.php" method="POST">
                        ...
                        <?php 
                            ...
                            $query = mysqli_query($conexao,"SELECT * FROM usuario WHERE Usuario_Codigo = 1");
                            ...
                            while($busca=mysqli_fetch_array($query)) {
                                ...
                                if($busca["Usuario_Email"]==$email_form and $busca["Usuario_Senha"]==$senha_form) {
										...
										session_start();
										$_SESSION['sessaoadm'] = "admbarbearia";
                                    header("location:usuarios.php");                                   
                                }
                                else {
                                    echo "<center> Você não tem acesso. </center>";
                                        }
